 ...
 */
  ...
  * 
  * @return Number - Standard deviation of the data set.  Welford's method is used for superior numerical stability at the cost of less computational efficiency.
  */
